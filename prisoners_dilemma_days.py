...
for price_new in dowjones:
    ...
    if price_old_2 < price_old < price_new and cash:  # buy if price increased for 2 days in row
        buy = cash
    ...
    elif price_old_2 > price_old > price_new and asset:  # sell if price decreased for 2 days in row
...
with open('result_days.csv', 'w') as datafile:
